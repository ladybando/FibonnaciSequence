...
/*        for(Object object : list){ loops thru list
        ...
        //System.out.println(dog1.equals(dog2)); //prints out false
        //dog.makeSound();// calls makeSound() and prints bark ** and wags tail due to override
        //dog.findFood(); calls findFood() method
        Dog dog1 = new Dog("bark"); //hashes are no longer equal due to diff sounds
